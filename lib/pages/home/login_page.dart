...
class LoginPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final iconColor = isDartNow && globalModel.currentThemeBean.colorBean != null
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          // TODO(flutter3-migration): replace FlareActor(.flr) with Rive/Lottie.
          // FlareActor package is deprecated and not installed
          Container(
