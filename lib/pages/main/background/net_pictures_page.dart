              ...
              ? SmartRefresher(
                  ...
                  footer: CustomFooter(
                    builder: (BuildContext context, LoadStatus? mode) =>
                        model.logic.getRefreshFooter(context, mode ?? LoadStatus.idle),
                  ),
                  child: GridView.builder(
                    itemCount: model.photos.length,
                    gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                        crossAxisCount: 2, //два столбца в ряду
                        childAspectRatio: 1.0 //область отображения с равной шириной и высотой
                        ),
