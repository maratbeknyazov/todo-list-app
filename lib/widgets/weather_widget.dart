...
class WeatherWidget extends StatefulWidget {
  ...
  const WeatherWidget({super.key, required this.globalModel});
...
class _WeatherWidgetState extends State<WeatherWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    final safeWeatherBean = weatherBean!;
    final BasicBean basicBean =
        safeWeatherBean.heWeather6[safeWeatherBean.heWeather6.length - 1].basic;
    final NowBean nowBean =
        safeWeatherBean.heWeather6[safeWeatherBean.heWeather6.length - 1].now;
    return Container(
