...
class FileUtil {
  ...
  static FileUtil getInstance() => _instance ??= FileUtil._internal();
  ...
  ///[assetPath] пример 'images/'
  ///[assetName] пример '1.jpg'
  ///[filePath] пример:'/myFile/'
  ///[fileName]  пример 'girl.jpg'
  ...
  void downloadFile(
      ...
      String? fileName,
      ValueChanged<String>? onComplete}) async {
