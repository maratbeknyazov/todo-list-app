...
//Этот класс извлекает информацию об иконках системы через файловые операции и различные операции со строками
//Локальный json файл также был создан таким образом, его можно использовать напрямую, очень удобно
class IconUtil {
  static IconUtil? _instance;

  static IconUtil getInstance() => _instance ??= IconUtil._internal();
