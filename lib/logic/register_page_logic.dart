...
// ============================================================================
// RegisterPageLogic - логика страницы регистрации
// Отправка данных регистрации на сервер, валидация полей
// ============================================================================
...
class RegisterPageLogic{
  ...
  String? validatorUserName(String userName) {
    ...
    if (userName.isEmpty) {
      ...
      debugPrint("Имя пользователя прошло проверку");
      _model.refresh();
      return null;
    }
  }
  ...
  String? validatorVerifyCode(String verifyCode) {
    ...
    if (verifyCode.isEmpty) {
      ...
      debugPrint("Код подтверждения прошел проверку");
      _model.refresh();
      return null;
    }
  }
  ...
  String? validatorEmail(String email) {
    ...
    if (email.isEmpty)
      ...
      _model.email = email;
      debugPrint("Email прошел проверку");
      _model.refresh();
      return null;
    }
  }
  ...
  String? validateRePassword(String rePassword) {
    ...
    if (rePassword.isEmpty) {
      ...
      debugPrint("Повторный пароль прошел проверку");
      _model.refresh();
      return null;
    }
  }
  ...
  String? validatePassword(String password) {
    ...
    if (password.isEmpty) {
      ...
      debugPrint("Пароль прошел проверку");
      _model.refresh();
      return null;
    }
  }
